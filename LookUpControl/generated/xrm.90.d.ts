...
declare namespace Xrm
{
    ...
    {
        /**
         * Indicates whether the client is executing in the Unified Interface.
         * @deprecated
         */
        isUci(): boolean;
    }
    ...
    namespace Events
    {
        ...
        interface StatusChangedEventArguments extends StageChangeEventArguments
        {
        ...
        interface StatusChangedEventContext extends EventContext
        {
            getEventArgs(): StatusChangedEventArguments;
        }
    ...
    namespace Collection
    {
        ...
        interface ItemCollection<T>
        {
            ...
            getFirst(filter: (item: T) => boolean): T;
    ...
    namespace Attributes
    {
        ...
        interface MultiOptionSetAttribute extends EnumAttribute
        {
            /**
             * Gets the attribute format.
             * @returns The format of the attribute.
    ...
    interface WebApiOffline
    {
         ...
         */
        retrieveRecord<T extends SCM.CRM.Entities.Core.IEntity>(entityLogicalName: string, id: string, options: string): Async.PromiseLike<T>;
         ...
         */
        retrieveMultipleRecords<T extends SCM.CRM.Entities.Core.IEntity>(entityLogicalName: string, options?: string, maxPageSize?: number): Async.PromiseLike<RetrieveMultipleResult<T>>;
	...
	/**
	 * Interface for the WebAPI RetrieveMultiple request typed response
	 */
    interface RetrieveMultipleResult<T extends SCM.CRM.Entities.Core.IEntity>
    {
        /**
    ...
    interface RequestMetadata
    {
        ...
        parameterTypes: ParameterTypeCollection;
    }

    interface ParameterTypeCollection
    {
    ...
    {
        enumProperties?: EnumParameterType;
    ...
    interface ExecuteResponse
    {
        ...
        url: string;
        /**
         * Request response of the action, function, or CRUD request that was sent to the Web API endpoint.
         */
        responseText: string;
        /**
...
declare namespace XrmEnum
{
    ...
    /**
     * Constant Enum: Operation types when executing requests from the WebApi
     * @see {@link Xrm.WebApiOnline.execute}
     */
    ...
    /**
     * Constant Enum: Types of parameters supplied to a WebApi request execution
     * @see {@link Xrm.WebApiOnline.execute}
     */
